    ...
    return Align(
      ...
      child: StreamBuilder<ExperiencesRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final containerExperiencesRecord = snapshot.data!;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      containerExperiencesRecord.experiencename1,
                    ...
                    Text(
                      valueOrDefault<String>(
                        containerExperiencesRecord.date?.toString(),
                        'no date',
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Inter',
                        ...
                        onPressed: () async {
                          await ReviewsRecord.collection
                              ...
                              .set(createReviewsRecordData(
                                ...
                                creatorID: containerExperiencesRecord.creator,
                              ));
                        },
                        text: 'Rate',
