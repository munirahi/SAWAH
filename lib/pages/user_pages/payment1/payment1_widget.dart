  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<BookedExpRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BookedExpRecord> payment1BookedExpRecordList = snapshot.data!;
                            ...
                            child: StreamBuilder<List<ExperiencesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ExperiencesRecord>
                                    priceSummaryExperiencesRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final priceSummaryExperiencesRecord =
                                    priceSummaryExperiencesRecordList.isNotEmpty
                                        ? priceSummaryExperiencesRecordList
                                            .first
                                        : null;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await widget.experienceRef!.update({
                                            ...mapToFirestore(
                                              {
