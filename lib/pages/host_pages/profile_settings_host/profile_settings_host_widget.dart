...
export 'profile_settings_host_model.dart';
...
class ProfileSettingsHostWidget extends StatefulWidget {
  ...
  State<ProfileSettingsHostWidget> createState() =>
      _ProfileSettingsHostWidgetState();
}

class _ProfileSettingsHostWidgetState extends State<ProfileSettingsHostWidget> {
  late ProfileSettingsHostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileSettingsHostModel());
                          ...
                          onTap: () async {
                            await launchUrl(Uri(
                                ...
                                query: {
                                  ...
                                  'body':
                                      'Dear Sawwah Team , I would like to get some help with',
                                }
                                    .entries
