...
class AuthEDITEDModel extends FlutterFlowModel<AuthEDITEDWidget> {
  ...
  String? _passwordCreateTextControllerValidator(
    ...
    if (!RegExp(
        ...
        .hasMatch(val)) {
      return 'Password must be at least 6 characters long and include letters, numbers, and special characters.';
    }
    return null;
  }
