...
import 'user_infooo_model.dart';
export 'user_infooo_model.dart';

class UserInfoooWidget extends StatefulWidget {
  const UserInfoooWidget({
    super.key,
    required this.nameee,
  });

  final DocumentReference? nameee;

  static String routeName = 'UserInfooo';
  static String routePath = '/userInfooo';

  @override
  State<UserInfoooWidget> createState() => _UserInfoooWidgetState();
}

class _UserInfoooWidgetState extends State<UserInfoooWidget> {
  late UserInfoooModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserInfoooModel());
